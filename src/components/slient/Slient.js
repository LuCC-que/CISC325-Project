...
function getWeather(latitude, longitude){
    ...
    function displayWeather(){
        iconElement.setAttribute("src", `${require(`./icons/${weather.iconId}.png`)}`);   //innerHTML = `src="./icons/01d.png" alt="weather">` //`<img src="./icons/unknown.png" alt="weather">`;
        ...
        <div className="weather">
          <div className="weather-container">
            <div className="weather-icon">
              <img className="weatherImg" src={require("./icons/unknown.png")} alt="" />
            </div>
